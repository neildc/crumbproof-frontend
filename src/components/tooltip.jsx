/**
 *  Credits: https://github.com/mcumpl/react-lightweight-tooltip/
 *
 *  Unmaintained as of 17/11/2017
 *      Use of proptypes from react breaks the app (v16 BC)
 *
 *      https://github.com/mcumpl/react-lightweight-tooltip/issues/223
 *
 *      That PR will solve that, but unpulled by maintainer
 *
 */
      ...
      <div
        ...
        {props.children}
        {
          ...
          <div ref="tooltip" style={styles.tooltip}>
            <div ref="content" style={styles.content} className={props.className}>{props.content}</div>
