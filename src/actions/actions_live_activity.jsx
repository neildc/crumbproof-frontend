...
export function fetchLiveActivity() {
  const request = axios.get(`${ROOT_URL}/activity/live/`, {
...
export function discardLiveActivity(id, callback) {
  ...
  const request = axios
    .delete(`${ROOT_URL}/activity/live/`, { headers: defaultHeadersWithAuth })
    .then(() => callback());
...
export function liveActivityNextStep() {
  ...
  const request = axios.post(`${ROOT_URL}/activity/live/next_step/`, payload, {
    headers: defaultHeadersWithAuth
  });
...
export function liveActivityStartTimer() {
  ...
  const request = axios.post(
    `${ROOT_URL}/activity/live/start_timer/`,
    payload,
    { headers: defaultHeadersWithAuth }
  );
