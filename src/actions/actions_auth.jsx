...
export const AUTH_TOGGLE_CONTENT_VISIBILITY = "auth_toggle_content_visibility";
...
export function authToggleContentVisibility() {
  return {
    type: AUTH_TOGGLE_CONTENT_VISIBILITY,
    payload: null
  };
}
